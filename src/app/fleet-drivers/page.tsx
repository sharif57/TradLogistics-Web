  ...
  return (
    <div className="space-y-8 mt-6 py-4 px-4 md:px-6 lg:px-8">
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
        ...
        <Link href="/fleet-drivers/add-new-zone" className="bg-gradient-to-l from-[#0776BD] to-[#51C7E1] p-4 text-center flex items-center justify-center gap-4 text-2xl font-medium text-white rounded-lg ">
          <Plus size={24} />
          <p>Add Zone</p>
        </Link>
      </div>
