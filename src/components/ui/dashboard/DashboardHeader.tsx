...
export default function DashboardHeader() {
  ...
  if (pathname === "/support" || pathname === "/inbox" || pathname === "/auth/login" || pathname === "/auth/forgot-password" || pathname === "/auth/reset-password" || pathname === "/auth/verify-email" || pathname === "/auth/business-information" || pathname === "/auth/sign-up") return null
  return (
